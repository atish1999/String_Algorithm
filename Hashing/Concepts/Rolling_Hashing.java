...
public class Rolling_Hashing implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Rolling_Hashing(), "Main", 1 << 26).start();
	}

	static long roll_hash(String s) {
		long power = 1, p = 31;
		long value = 0;
	...
	public void run() {
		...
		while (t-- > 0) {
			String o = fr.next();
			System.out.println("hashKey of " + o + " is " + roll_hash(o));
