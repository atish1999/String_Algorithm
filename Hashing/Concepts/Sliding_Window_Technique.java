...
public class Sliding_Window_Technique implements Runnable {
	...
	*/
	...
	static boolean match(int l) {//O(m)
		for(int i=0; i<m; i++) {
			if(original.charAt(l+i)!=pattern.charAt(i)) return false;
		}
		return true;
	}
	@Override
